...
export default function News() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Hero */}
      <div className="relative bg-brand-primary text-white py-16 px-4 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <p className="text-white/70 text-lg max-w-xl">The latest from our campus — achievements, updates, and events</p>
        </div>
      </div>
            ...
            <div className="grid md:grid-cols-5">
              ...
              <div className="md:col-span-3 p-8 flex flex-col justify-center">
                <div className="flex items-center gap-2 mb-3">
                  <span className="bg-brand-accent text-brand-primary text-xs font-bold px-3 py-1 rounded-full">⭐ Featured</span>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-brand-primary text-sm font-semibold flex items-center gap-1.5 group-hover:gap-2.5 transition-all">
          ...
          {(activeCategory === "All" ? filtered.slice(1) : filtered).map(item => (
            ...
            >
              ...
              <div className="p-5 flex-1 flex flex-col">
                <h3 className="font-bold text-gray-900 text-sm leading-snug mb-2 flex-1 group-hover:text-brand-primary transition-colors">{item.title}</h3>
                <p className="text-gray-500 text-xs leading-relaxed mb-4 line-clamp-2">{item.desc}</p>
                <div className="flex items-center justify-between pt-2 border-t border-gray-50">
                  <div className="flex items-center gap-1.5 text-gray-400 text-xs">
                    <Calendar className="h-3.5 w-3.5" />{item.date}
                  </div>
                  <span className="text-brand-primary text-xs font-semibold flex items-center gap-1 group-hover:gap-2 transition-all">
          ...
          >
            ...
            <div className="p-6">
              ...
              <div className="mt-6 flex items-center justify-between pt-4 border-t border-gray-100">
                <span className="text-xs text-gray-400">Campus News</span>
                <button
                  onClick={() => setSelected(null)}
                  className="text-sm font-semibold text-brand-primary hover:text-brand-primary transition-colors"
                >
                  Close Article
                </button>
              </div>

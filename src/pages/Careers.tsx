...
import { z } from "zod";
import { useCreateCareer } from "@/lib/api-client/index";
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="bg-gradient-to-br from-brand-primary to-brand-primary text-white py-12 px-4">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-4xl font-bold mb-3">Work Culture @ {shortName}</h1>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-12">
          {culture.map(({ icon: Icon, title, desc }) => (
            <div key={title} className="bg-card border border-border rounded-xl p-5 text-center">
              <div className="h-12 w-12 mx-auto bg-brand-primary/10 rounded-xl flex items-center justify-center mb-3">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          <div>
            ...
            <p className="text-muted-foreground mb-6 leading-relaxed">
              At {collegeName}, we believe our faculty and staff are our greatest strength. We are committed to providing a rewarding work environment that supports personal and professional growth.
            </p>
          ...
          <div>
            {submitted ? (
              <div className="bg-green-50 border border-green-200 rounded-2xl p-10 text-center">
                ...
                <p className="text-muted-foreground mb-6">Thank you for your interest in working with {collegeName}. We'll review your application and reach out soon.</p>
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="bg-card border border-border rounded-2xl p-8 space-y-5" data-testid="careers-form">
                ...
                <button data-testid="button-submit" type="submit" disabled={createCareer.isPending} className="w-full bg-brand-primary text-white font-bold py-3.5 rounded-lg hover:opacity-80 transition-colors disabled:opacity-50">

        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-16">
          <div className="max-w-2xl">
            ...
            <p className="text-white/70 text-lg leading-relaxed">
              India's leading companies trust {shortName} graduates. Our students are placed across technology, banking, media, consulting, and core industry sectors.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-100">
            {highlights.map(h => (
              <div key={h.label} className="py-5 px-6 text-center">
                ...
                <div className="text-2xl font-bold text-brand-primary">{h.value}</div>
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 py-10 w-full space-y-8">
        <div className="text-center mb-8">
          <p className="text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Over <strong>120 companies</strong> across 5 industry sectors actively recruit from {shortName}'s campuses.
        ...
        {/* CTA */}
        <div className="bg-gradient-to-br from-brand-primary to-brand-primary rounded-2xl p-8 text-white text-center">
          <h2 className="text-2xl font-bold text-brand-accent mb-3">Work at Your Dream Company</h2>
          ...
          <div className="flex flex-wrap gap-3 justify-center">
            <Link href="/apply" className="bg-brand-accent text-[var(--brand-primary)] font-bold px-8 py-3 rounded-lg hover:opacity-90 transition-colors">
              Apply Now
            </Link>

...
export default function Law() {
  return (
    <SchoolPage
      ...
      intro="The School of Law offers BA LL.B and LL.M programs with a strong emphasis on practical legal education. Our moot court facility, legal aid clinic, and connections with practicing attorneys ensure that students graduate with both theoretical knowledge and courtroom-ready skills."
      highlights={[

...
export default function CSIT() {
  return (
    <SchoolPage
      ...
      intro="The School of Computer Science & IT offers BCA and MCA programs with a strong focus on practical programming, modern technologies, and emerging fields like Artificial Intelligence and Machine Learning. Our state-of-the-art labs with the latest hardware and software ensure students get hands-on experience from day one."
      highlights={[

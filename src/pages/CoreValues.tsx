    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="bg-gradient-to-br from-brand-primary to-brand-primary text-white py-12 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-white/70 text-lg">The principles that guide everything we do at {collegeName}</p>
        </div>
      </div>
      <main className="flex-1 max-w-7xl mx-auto px-4 py-12 w-full">
        <div className="text-center mb-12">
          <p className="text-muted-foreground text-lg max-w-3xl mx-auto leading-relaxed">
            At {collegeName}, our core values are not simply words on paper — they are the living principles that shape our culture, guide our decisions, and define our identity as an institution.
          </p>
        </div>

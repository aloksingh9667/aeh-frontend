        ...
        <div className="w-full max-w-md">
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
            <div className="bg-brand-primary px-8 py-8 text-center">
              <GraduationCap className="h-12 w-12 text-brand-accent mx-auto mb-3" />
            ...
            <div className="px-8 py-8">
                ...
                <form onSubmit={handleEmailSubmit} className="space-y-5">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-primary text-sm"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        required
                        className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-primary text-sm pr-12"
                      />
              ...
              {step === "done" && (
                <div className="text-center space-y-4 py-4">
                  ...
                  <button onClick={() => setLocation("/student/login")} className="w-full bg-brand-primary text-white py-3 rounded-lg font-semibold hover:opacity-80 transition-colors">
                    Go to Login
                  </button>
                </div>
              )}
              ...
              {step !== "done" && (
                <div className="mt-5 text-center">
                  <Link href="/student/login" className="text-sm text-brand-primary hover:underline flex items-center justify-center gap-1">

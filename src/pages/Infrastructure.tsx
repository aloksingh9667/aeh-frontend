...
const facilities = [
  ...
  },
  {
    ...
    desc: "Hygienic, affordable cafeteria serving nutritious meals — a social hub for the campus community",
    ...
    <div className="min-h-screen flex flex-col">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-20 md:py-28">
          <div className="max-w-2xl">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4 leading-tight">
              Our <span className="text-brand-accent">Infrastructure</span>
            </h1>
            <p className="text-white/70 text-lg leading-relaxed max-w-xl">
              A premier campus designed to provide students with an environment that fosters learning, creativity, and personal development.
            </p>
          </div>
        </div>
      </div>
      ...
      <main className="flex-1 bg-gray-50 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          {/* CTA */}
          <div className="mt-16 bg-brand-primary rounded-2xl p-10 text-center text-white">
            <h2 className="text-2xl font-bold text-brand-accent mb-3">Experience It Yourself</h2>
            <p className="text-white/70 mb-6 max-w-xl mx-auto">
              Visit our campus and see our world-class facilities. Schedule a tour or apply now to begin your journey with us.
            </p>
            <div className="flex flex-wrap gap-4 justify-center">
              <a href="/apply" className="bg-brand-accent text-[var(--brand-primary)] font-bold px-8 py-3 rounded-xl hover:opacity-90 transition-colors">
                Apply Now
              </a>

...
const testimonials = [
  ...
  },
  {
    ...
    text: "Getting placed at Infosys felt like a dream. AEH made it possible through rigorous technical training and dedicated placement support.",
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <div className="relative overflow-hidden bg-brand-primary text-white">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-brand-primary/90 via-[var(--brand-primary)]/80 to-transparent" />
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-20 md:py-28 grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4 leading-tight">
              Our Glorious<br />
              <span className="text-brand-accent">Placement Record</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-3 mt-8">
              <Link href="/apply" className="bg-brand-accent text-[var(--brand-primary)] font-bold px-6 py-3 rounded-xl hover:opacity-90 transition-colors">
                Join Our Next Batch
              </Link>
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 py-12 w-full space-y-14">
            ...
            {processSteps.map(({ icon: Icon, title, desc, step }) => (
              <div key={step} className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 relative overflow-hidden hover:shadow-md transition-shadow">
                ...
                <div className="relative">
                  <div className="h-12 w-12 bg-brand-primary rounded-xl flex items-center justify-center mb-4">
        ...
        <section className="bg-white rounded-2xl p-6 md:p-8 shadow-sm border border-gray-100">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="relative">
              ...
              />
              <div className="absolute -bottom-4 -right-4 bg-brand-primary text-white rounded-xl p-4 shadow-lg">
                <div className="text-2xl font-bold text-brand-accent">1100+</div>
            ...
            {placed.map(student => (
              <div key={student.name} className="bg-white border border-gray-100 rounded-2xl p-5 text-center hover:shadow-md hover:-translate-y-1 transition-all duration-200 group">
                <img
                  src={student.img}
                  alt={student.name}
                  className="h-16 w-16 rounded-full object-cover mx-auto mb-3 border-2 border-gray-100 group-hover:border-[var(--brand-accent)] transition-colors shadow-sm"
                />
                ...
                <div className="mt-3 space-y-1.5">
                  <div className="bg-brand-primary text-white text-xs font-medium px-3 py-1.5 rounded-full">{student.company}</div>
            ...
            {testimonials.map(t => (
              <div key={t.name} className="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 hover:shadow-lg transition-shadow">
                ...
                <div className="p-5">
                  ...
                  <div className="flex items-center gap-1.5 text-brand-primary text-xs font-semibold">
        ...
        {/* CTA */}
        <section className="bg-gradient-to-r from-[var(--brand-accent)] to-[var(--brand-accent)] rounded-2xl p-10 text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-[var(--brand-primary)] mb-3">Your Success Story Starts Here</h2>
          <p className="text-brand-primary mb-8 max-w-xl mx-auto">Join 1100+ placed graduates. Admissions open for 2026-27.</p>
          <div className="flex flex-wrap gap-4 justify-center">
            <Link href="/apply" className="bg-brand-primary text-white font-bold px-8 py-3 rounded-xl hover:bg-brand-primary transition-colors">
              Apply Now — Free
            </Link>
            <Link href="/top-recruiters" className="flex items-center gap-2 bg-white text-brand-primary font-semibold px-6 py-3 rounded-xl hover:bg-gray-50 transition-colors">

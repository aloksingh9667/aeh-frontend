...
import { useListCareers } from "@/lib/api-client/index";
              ...
              <tbody className="divide-y divide-border">
                {isLoading ? (
                  ...
                  <tr key={career.id} className="hover:bg-muted/20">
                    ...
                    <td className="px-4 py-3">
                      {career.cvUrl ? (
                        <a href={career.cvUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 text-brand-primary text-xs font-medium hover:underline">
